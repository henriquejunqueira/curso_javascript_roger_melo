...
const my3FavoriteTVShows = ['Fallout', 'Stranger Things', 'Breaking Bad'];
...
const numero_caracteres = 39;

// console.log(
//   `A string que a "typeSentence" armazena tem mais de ${numero_caracteres} caracteres? ${String(
//     typeSentence.length > numero_caracteres
//   ).replace('t', 'T')}.`
// );
...
// console.log(evenNumbers.indexOf(8) !== false);
